/*
 ...
 MSKFONT4 utility for the XTile graphics manager

 COPYRIGHT (C) 1993  Erich P Gatejen   All Rights Reserved


 File: MSKFONT4.C    	Written for the Turbo C compiler


 Will create a mask set for a 4-pixel .FNT font.


*/

#define   CHARSIZE		24	/* size in bytes of each character */ 
#define   Psize		6    /* size in bytes of each plane	*/
...
void main () {
	...
	for ( mainloop = 0; mainloop < Number; mainloop++ ) {
	   ...
	   /* Loop through each XBlock set and make the mask	*/
	   ...
	   for ( step = 0; step < 3; ++step ) {
		...
		current = base + 1;          /* Adjust to look for high nibble */
